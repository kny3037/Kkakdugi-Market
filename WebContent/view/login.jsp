 ...
 <form action="signIn.do" method="post" class="loginForm">
      ...
      <div class="bottomText">
       ...
       <a href='javascript:void(0);' onclick="findPw()" >비밀번호 찾기</a>
	      ...
	      <!-- 카카오 로그인 -->
	  <div class="kakaoLogo">
	      <a href="https://kauth.kakao.com/oauth/authorize?client_id=d2b3ba824e744e5c470824907863b20b&redirect_uri=http://192.168.0.95:8089/Kkakdugi_Market/kakaoLogin.do&response_type=code">
